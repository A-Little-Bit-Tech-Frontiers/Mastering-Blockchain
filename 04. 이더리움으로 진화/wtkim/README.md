...
스마트 콘트랙트를 활용한 전산 거래 프로토콜의 사용 사례로 ICO 가 있다. ICO 는 주식이 아닌 코인으로 IPO 를 하는 것과 비슷한 개념이다. 이더리움은 ICO 를 통해 42일 만에 13,000 BTC 를 모금했다. ICO 당시 이더리움의 가격은 0.31 달러였는데, 출시 1년 후 10 달러로 오르며 크게 성공했다. 이더리움의 성공은 ICO 를 블록체인 사업의 표준으로 만들었다. 이를 시작으로 암호화폐가 다양한 거래에 사용될 수 있다는 것을 증명한 계기가 되었다.
